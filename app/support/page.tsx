    ...
    <div className="page-shell">
      ...
      <main id="main">
        ...
        <div className="shell prose-section"><div className="support-grid">
          ...
          <article className="support-topic"><h2>Run Legacy Apple OCR</h2><p>Choose Legacy Apple OCR when creating a BookMap to scan entirely on your device for free.</p></article>
